...
public class RoleController {
  ...
  public ResponseEntity<Response> getRoles() {
    try {
      ...
      return new ResponseEntity<Response>(new Response(false, "error", this.responseService.errors(e.getMessage())), HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  public ResponseEntity<Response> getRoleById(@PathVariable Long id) {
    try {
      ...
      if (dbRole == null) {
        ...
        return new ResponseEntity<Response>(new Response(false, "error", this.responseService.errors(message)), HttpStatus.OK);
      }
