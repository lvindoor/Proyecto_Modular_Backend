...
public class HistoryController {
    ...
    public ResponseEntity<List<History>> getAllWhoCompletedChallengeToday() {
	...
	public ResponseEntity<Response> create(@PathVariable Long passengerId, @PathVariable Long stationId, @RequestBody History history) {
		try {
